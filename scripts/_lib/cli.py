"""scripts/_lib/cli.py — shared scaffolding for the `ad-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("ad-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/ad-foo`
...
VERSION = "0.1.0"  # bumped centrally; every ad-* CLI reports this
