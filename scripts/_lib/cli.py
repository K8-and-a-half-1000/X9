"""scripts/_lib/cli.py — shared scaffolding for the `x9-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("x9-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/x9-foo`
...
VERSION = "0.1.0"  # bumped centrally; every x9-* CLI reports this
