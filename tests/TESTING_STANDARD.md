# AD Testing Standard & Taxonomy

## Purpose

This document defines *how we write and refactor tests* in AD. It is the
...
| **Background** | Background jobs, delivery | `test_bg_*` | `tests/services/` |
