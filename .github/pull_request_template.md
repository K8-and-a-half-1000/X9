...
- [ ] I searched [open issues](https://github.com/K8-and-a-half-1000/X9/issues) and [open PRs](https://github.com/K8-and-a-half-1000/X9/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses X9's existing visual language. Specifically:
